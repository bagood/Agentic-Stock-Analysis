...
from app.models.hold_strategy import HoldStrategyReport

PROJECT_ROOT = Path(__file__).resolve().parents[2]
HOLD_STRATEGY_RESULT = PROJECT_ROOT / "holdStrategyResults"


class HoldStrategyRepository:
    """Read generated hold-strategy reports from the filesystem."""

    def __init__(self, results_directory: Path = HOLD_STRATEGY_RESULT) -> None:
