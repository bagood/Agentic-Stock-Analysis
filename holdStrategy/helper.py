...
def build_hold_strategy_prompt(
    ...
    return (
        ...
        f"position within the source report’s fixed {trading_window} window, "
        "preserving its original dated expiry. The stored average acquisition "
        ...
        "or sell at the next reasonably available opportunity, or report insufficient "
        "data when a responsible decision is unavailable. Follow every instruction "
        "above and use only the "
