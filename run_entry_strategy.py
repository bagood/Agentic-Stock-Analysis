...
WINDOW_CONFIGS = {
    "5": {
        "instructions_path": "instructions/stock-entry-strategy-5-instructions.md",
        "rolling_window": "5dd",
        "trading_window": "5 trading sessions",
    },
    "10": {
        "instructions_path": "instructions/stock-entry-strategy-10-instructions.md",
        "rolling_window": "10dd",
...
def main(forecast_window: str = "10") -> int:
    try:
        load_env(ENV_PATH)
        ...
        strategy_root = resolve_project_path(
            os.environ.get("ENTRY_STRATEGY_RESULT", "entryStrategyResults")
        )
